...
------------------------------------------------------------------------------*/
    ...
    SELECT SEHIR,MAAS FROM PERSONEL WHERE MAAS>5000;
                  -- UNION ALL kullanılırsa tekrarli veriler elenmez.
...
------------------------------------------------------------------------------*/  
    ...
    SELECT MAAS,ISIM AS IS_SEH FROM PERSONEL WHERE ISIM='Mehmet Ozturk'
    UNION 
...
------------------------------------------------------------------------------*/    
   ...
   SELECT SEHIR,MAAS AS SEH_MAAS FROM PERSONEL WHERE ID= 123456789
   UNION 
...
------------------------------------------------------------------------------*/
    SELECT * FROM PERSONEL WHERE ISIM='Mehmet Ozturk'
    MINUS 
    SELECT * FROM PERSONEL WHERE SEHIR ='Istanbul';
               -- Sehiri Istanbul olmayan
